...
from json_operations import load_map_from_json
...
def main():
    ...
    if answer.upper() == "Y":
        ...
        # defined_markers = define_markers(raw_markers)  # TODO

        # output json markers
        json_marker_filename = make_json_filename(marker_filename)
        # save_map_to_json(defined_markers, json_marker_filename) # TODO
